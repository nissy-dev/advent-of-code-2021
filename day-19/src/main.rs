...
// see: https://github.com/jeffomatic/adventofcode/blob/main/2021-rust/day19b/src/main.rs
// あんまり理解できてないけど、一応コピペしてみた
...
fn find_offset(a: &HashSet<Vec3>, b: &HashSet<Vec3>, min_similar: usize) -> Option<Vec3> {
    for a_origin in a.iter() {
        ...
        for b_origin in b.iter() {
            ...
            // 相対座標を元に、少なくとも12個の座標が同じかどうか判定する
...
fn part1_solver() {
    ...
    while lines.peek().is_some() {
        ...
        // 回転後の座標を計算、キーが回転の種類、値が回転後のすべての座標
